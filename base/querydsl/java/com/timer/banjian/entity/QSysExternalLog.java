...
public class QSysExternalLog extends EntityPathBase<SysExternalLog> {
    ...
    private static final long serialVersionUID = -54170194L;

    public static final QSysExternalLog sysExternalLog = new QSysExternalLog("sysExternalLog");

    public final com.timer.common.entity.QOnlyIdEntity _super = new com.timer.common.entity.QOnlyIdEntity(this);
