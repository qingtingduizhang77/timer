...
import com.timer.common.entity.OnlyIdEntity;
...
public class SysExternalLog extends OnlyIdEntity {
    ...
    public SysExternalLog(String reqDesc, String resDesc, int type, String message, String appId, int status, Date created, String apiType) {
