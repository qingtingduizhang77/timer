package com.timer.common.utils;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.timer.banjian.service.SpResultsService;
import com.timer.config.springboot.InitListenter;
...
public class TypeNameUtil {
    ...
    public static String getTypeName(String key, String code){
        SpResultsService service = InitListenter.getBean("spResultsService", SpResultsService.class);
        String sysConfig = service.getOutDataDic();
        return getCodeNameByKeyAndCode(sysConfig, key, code);
    }
    ...
    public static String getTypeKeyByValue(String key, String value){
        SpResultsService service = InitListenter.getBean("spResultsService", SpResultsService.class);
        String sysConfig = service.getOutDataDic();
        return getKey(getDataDicByKey(sysConfig, key), value);
    }
    ...
    public static JSONObject getDataDicByKey(String data, String key){
        JSONObject jsonObject = (JSONObject) JSON.parse(data.replace("\\", ""));
